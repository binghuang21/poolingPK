        ...
        #如果碰到screen边，掉头
            ...
            if new_y >= 155:
                ...
                if new_x >= self.SCREEN_WIDTH - 10:
                    self.pos[0] = self.SCREEN_WIDTH - 11
                    #new_x = self.pos[0]
                    ...
                    self.velocity[0] = -0.5    #掉头weishenmewuxiao
                    self.velocity[1] = 0
...
class Counter(Agent):
    ...
    def update(self, dt):
        ...
        if flag:
            ...
            if new_x > 100 and new_x < self.SCREEN_WIDTH - 100 and new_y > 100 and new_y < self.SCREEN_HEIGHT - 100 \
                    or self.pos[0] > self.SCREEN_WIDTH - 90 or self.pos[1] > self.SCREEN_HEIGHT - 90:
                new_x = 100
                new_y = 100
                #self.velocity[1] = 1
                #self.velocity[0] = 0
            elif self.pos[0] <= 100 and self.pos[1] < self.SCREEN_HEIGHT - 100:
                self.velocity[1] = 0.5
                self.velocity[0] = 0
            elif self.pos[0] <= 100 and self.pos[1] >= self.SCREEN_HEIGHT - 100:
                self.velocity[1] = 0
                self.velocity[0] = 0.5
            elif self.pos[1] > self.SCREEN_HEIGHT - 100 and self.pos[0] >= self.SCREEN_HEIGHT - 100:
                self.velocity[1] = -0.5
                self.velocity[0] = 0
            elif self.pos[1] < 100 and self.pos[0] >= self.SCREEN_HEIGHT - 100:
                self.velocity[1] = 0
                self.velocity[0] = -0.5
...
class Sniper(Agent):
    ...
    def update(self, dt):
        ...
        if flag:
            ...
            if new_x > 20 and new_x < self.SCREEN_WIDTH - 20 and new_y > 20 and new_y < self.SCREEN_HEIGHT - 20:
                new_x = 20
                new_y = 20
            elif self.pos[0] <= 20 and self.pos[1] < self.SCREEN_HEIGHT - 20:
                self.velocity[1] = 1
                self.velocity[0] = 0
            elif self.pos[0] <= 20 and self.pos[1] >= self.SCREEN_HEIGHT - 20:
                #new_y = self.SCREEN_HEIGHT - 20
                self.velocity[1] = 0
                self.velocity[0] = 1
            elif self.pos[1] > self.SCREEN_HEIGHT - 20 and self.pos[0] >= self.SCREEN_HEIGHT - 20:
                self.velocity[1] = -1
                self.velocity[0] = 0
            elif self.pos[1] < 20 and self.pos[0] >= self.SCREEN_HEIGHT - 20:
                self.velocity[1] = 0
                self.velocity[0] = -1
        ...
        if flag:
            ...
            if self.pos[0] > 25 and self.pos[0] < self.SCREEN_WIDTH - 25 and self.pos[1] > 25 and self.pos[1] < self.SCREEN_HEIGHT - 25:
                new_x = 24
                new_y = 24
            elif self.pos[0] < 25 and self.pos[1] < 25:
                self.velocity[1] = 0
                self.velocity[0] = 1
            elif self.pos[0] < 25 and self.pos[1] >= self.SCREEN_HEIGHT - 25:
                #new_y = self.SCREEN_HEIGHT - 20
                self.velocity[1] = -1
                self.velocity[0] = 0
            elif self.pos[1] > self.SCREEN_HEIGHT - 25 and self.pos[0] >= self.SCREEN_HEIGHT - 25:
                self.velocity[1] = 0
                self.velocity[0] = -1
            elif self.pos[1] < 25 and self.pos[0] >= self.SCREEN_HEIGHT - 25:
                self.velocity[1] = 1
                self.velocity[0] = 0
